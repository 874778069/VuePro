<template>
    <div class="shop-header">
      <nav class="shop-nav"
        ...
        <a class="back">
          <i class="iconfont icon-arrow_left" @click="backAndClear"/>
        </a>
      </nav>
        ...
        <div class="activity-sheet" v-show="isShowSupport">
          <div class="activity-sheet-content">
            <h2 class="activity-sheet-title">
              优惠活动</h2>
            <ul class="list">
              <li class="activity-item" :class="supClasses[support.type]" v-for="support in info.supports">
                <span class="content-tag">
    ...
    export default {
      ...
      data(){
          return{
            ...
            isShowSupport : false,
            supClasses :['activity-green', 'activity-red', 'activity-orange']
          }
      },
        computed:{
          ...mapState(["info"]),
      ...
      methods:{
          backAndClear(){
            if(this.totalCount){
              MessageBox.confirm("退出将清空购物车,你确定退出吗?").then(()=>{
                this.$router.back();
